...
export default {
  ...
  methods: {
    ...
    getCompetence () {
      var _this = this
      this.thisCancas = document.getElementById('canvasCamera3')
      this.thisContext = this.thisCancas.getContext('2d')
      this.thisVideo = document.getElementById('videoCamera3')
    ...
    stopNavigator () {
      ...
      // this.videoCamera3.srcObject.getTracks()[0].stop()
    }
  }
}
</script>

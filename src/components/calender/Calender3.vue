  ...
  <div class="Calender3">
    ...
    <div v-if="false" class="month">
      <div class="month-left">
        ...
        <div @click="pickNext(currentYear,currentMonth)"> z
          下月
        </div>
      </div>
    ...
    <!-- 日期 -->
    <div class="days">
      <div v-for="(day, index) in days" :key="index" class="li" @click="pick(day)">
        <!--本月-->
        <div v-if="day.getMonth()+1 != currentMonth" class="other-month">
          <!-- <p>{{ day.getDate() }}</p> -->
          <div v-if="!dateArr.includes(day.toLocaleDateString())">待签到</div>
          <div v-if="dateArr.includes(day.toLocaleDateString())" class="end">已签到</div>
        </div>
        <div v-else>
          <!--今天-->
          ...
          <div v-if="new Date(day).setHours(0, 0, 0, 0)==new Date().setHours(0, 0, 0, 0)" class="active">
